...
async function newDb() {
  ...
  await db.run(`INSERT INTO users (school_id, password_hash, admin) 
    SELECT 'testaccount', 'dfe2b81efc39922409696e9c8ded27f7551cb36417556cae0c7c7c4f661747fe', 0
    WHERE NOT EXISTS (SELECT 1 FROM users WHERE school_id = 'testaccount')
  `);
  await db.run(`INSERT INTO users (school_id, password_hash, admin)
    SELECT 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 1
    WHERE NOT EXISTS (SELECT 1 FROM users WHERE school_id = 'admin')
  `);
